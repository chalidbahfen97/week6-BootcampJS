...
export default function EditCategories(props) {
    ...
    useEffect(() => {
      apiCategories.findRowById(props.action.id)
      .then((result)=>{
        setValues({...values,cate_id : result.data.cate_id , cate_name : result.data.cate_name})
      })
  }, [props.action.id])
    ...
    const onSubmit = async ()=>{
        ...
        const result = await apiCategories.updateRow(data);
